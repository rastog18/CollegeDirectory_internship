...
public partial class Authorise : AuthoriseBase
{
...
WriteLiteral(">Are you who you say you are ?</h1>\n        </div>\n        <div");

WriteLiteral(" class=\"btns\"");

WriteLiteral(">\n            <button");

WriteLiteral(" onclick=\"location.href=\'/Auth/ValidateToken\';\"");
...
WriteLiteral(" onclick=\"location.href=\'/Auth/GetToken\';\"");
...
WriteLiteral(">GenerateToken</button>\n        </div> \n    </div>\n    \n</body>\n\n\n");
...
public abstract class AuthoriseBase
{
